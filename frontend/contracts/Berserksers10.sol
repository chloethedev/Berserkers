...
contract Berserkers10  {
    ...
    function topUp () external payable{playerVault[msg.sender] = playerVault[msg.sender].add(msg.value);}
        ...
        public
    {
        ...
        for(uint256 i=0;i<totalSupplyStake;i++){
            owner[i] = 0x67EdFe6E933b6A9bCB923E036D976b48e43cF330;
            soldierAmount[i]= 200;
        }
        // 0 : cav
        // 1 : S
        ...
        stake[0x67EdFe6E933b6A9bCB923E036D976b48e43cF330] = 10;
    }
     // events
